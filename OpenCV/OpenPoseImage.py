...
directory = "Input/"
image_file = "chiboard1.png"
MODE = "COCO"

parser = argparse.ArgumentParser(description='Run keypoint detection')
parser.add_argument("--device", default="cpu", help="Device to inference on")
parser.add_argument("--image_file", default=directory+image_file, help="Input image")
...
print("Image width:", frameWidth)
frameHeight = frame.shape[0]
print("Image Height:", frameHeight)
threshold = 0.1
...
cv2.imwrite('OutputImage'+MODE+'/'+str(image_file.split(".")[0])+'-Keypoints-'+MODE+'.jpg', frameCopy)
cv2.imwrite('OutputImage'+MODE+'/'+str(image_file.split(".")[0])+'-Skeleton-'+MODE+'.jpg', frame)
